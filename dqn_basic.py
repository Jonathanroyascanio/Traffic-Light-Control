...
models_dir = "./models/DQN_basic"
logs_dir = "logs"

#Training code for DQN base model
if __name__=="__main__":
    ...
    model.learn(total_timesteps=steps_per_episode*total_episodes, reset_num_timesteps=False, tb_log_name="DQN_basic")
